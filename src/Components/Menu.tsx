...
import {AiFillContacts, AiFillNotification} from "react-icons/ai";
        ...
        <MenuBase $mobile={horizontal}>
            ...
            {!horizontal &&
             <MenuFooter className="grid items-center justify-items-center grid-rows-[1fr_1fr] grid-cols-[7fr_10fr_1fr] text-white">
                <ProfilePicture className="p-2 row-span-full w-full" Id={data?.data.id ?? ''} />
                 ...
                 <div className="col-start-2 self-start row-start-2 text-center">
                     <p className="text-[7px] text-[#6F6F6F] font-bold">{data?.data.email}</p>
                 </div>
             </MenuFooter>
            }
        </MenuBase>
